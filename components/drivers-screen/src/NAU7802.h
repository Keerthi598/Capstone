...
/*
  Controls the NAU Code, teh analog digital convertor
...
public:
    ...
    bool setBit(uint8_t bitNumber, uint8_t regAddr);
    bool clearBit(uint8_t bitNumber, uint8_t regAddr);
    bool getBit(uint8_t bitNumber, uint8_t regAddr);
